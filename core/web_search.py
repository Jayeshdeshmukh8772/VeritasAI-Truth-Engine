...
Queries DuckDuckGo via the free 'ddgs' library to fetch live web snippets.
...
def search_web(query: str, max_results: int = 3) -> str:
    ...
    try:
        ...
        logger.error(f"Web search failed for query '{query}': {str(e)}", extra={"context": "web_search"})
        return ""
